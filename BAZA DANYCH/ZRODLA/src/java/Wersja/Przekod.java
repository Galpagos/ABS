...
//	private  void przekodzik() throws IOException {
		...
		try (Database db = DatabaseBuilder.open(new File(mSciezkaDoBazy))) {
			System.out.println("Podbito wersj�");
		...
		updateAbsencja(SLRodzajeAbsencji.ciaza, SLEkwiwalentZaUrlop.PROCENT_100);
		...
		updateAbsencja(SLRodzajeAbsencji.urlop_okolicznosciowy, SLEkwiwalentZaUrlop.PROCENT_100);
		updateAbsencja(SLRodzajeAbsencji.urlop_ojcowski, SLEkwiwalentZaUrlop.PROCENT_100);
		updateAbsencja(SLRodzajeAbsencji.urlop_macierzynski, SLEkwiwalentZaUrlop.PROCENT_80);
