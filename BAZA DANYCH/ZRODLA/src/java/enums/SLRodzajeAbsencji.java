...
public enum SLRodzajeAbsencji implements InterfejsSlownika {
	...
	opieka_na_kogos("oK", "Opieka na kogoś", new Color(9, 200, 18), "5", SLEkwiwalentZaUrlop.PROCENT_80), //
	...
	ciaza("C", "Ciąża", new Color(9, 200, 18), "8", SLEkwiwalentZaUrlop.PROCENT_100), //
	urlop_ojcowski("uOJ", "Urlop ojcowski", new Color(51, 51, 255), "9", SLEkwiwalentZaUrlop.PROCENT_100), //
	urlop_macierzynski("uM", "Urlop macierzyński", new Color(51, 51, 255), "10", SLEkwiwalentZaUrlop.PROCENT_80), //
	urlop_rodzicielski("uR", "Urlop rodzicielski", new Color(51, 51, 255), "11", SLEkwiwalentZaUrlop.PROCENT_80), //
	urlop_okolicznosciowy("uOK", "Urlop okolicznościowy", new Color(249, 216, 85), "12",
	...
	swiadczenie_rehab("SwR", "świadczenie rehab.", new Color(155, 155, 15), "18", SLEkwiwalentZaUrlop.PROCENT_90), //
